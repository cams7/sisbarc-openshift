 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://ws.teste.cams7.com.br/", wsdlLocation = "http://192.168.1.50:8080/acende_apaga_leds/sayhello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICEIMPLSERVICE_QNAME = new QName("http://ws.teste.cams7.com.br/", "HelloServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.1.50:8080/acende_apaga_leds/sayhello?wsdl");
    ...
    public HelloService getHelloServiceImplPort() {
        return super.getPort(new QName("http://ws.teste.cams7.com.br/", "HelloServiceImplPort"), HelloService.class);
    }
    ...
    public HelloService getHelloServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.teste.cams7.com.br/", "HelloServiceImplPort"), HelloService.class, features);
    }
